  ...
  return (
    <CardWrapper>
      <InfoWrapper>
        ...
        <Media>
          <li key = 'emails'>
            {emails ? <ExternalAnchor href={'mailto:' + emails[0]} target="_blank">
            {mediaIcons.emails}
          </ExternalAnchor> : null}
          </li>
          <li key ='phones'>
            {phones ? <ExternalAnchor href={'tel:' + phones[0]} target="_blank">
            {mediaIcons.phones}
          </ExternalAnchor> : null}
          </li>
          <li keys = 'urls'>
            {urls ? <ExternalAnchor href={urls[0]} target="_blank">
            {mediaIcons.urls}
          </ExternalAnchor> : null}
          </li>
          {outlets}
